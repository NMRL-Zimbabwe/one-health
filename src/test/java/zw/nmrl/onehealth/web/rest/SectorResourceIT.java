...
class SectorResourceIT {
    ...
    public static Sector createEntity(EntityManager em) {
        Sector sector = new Sector().name(DEFAULT_NAME).code(DEFAULT_CODE);
        return sector;
    }
    ...
    public static Sector createUpdatedEntity(EntityManager em) {
        Sector sector = new Sector().name(UPDATED_NAME).code(UPDATED_CODE);
        return sector;
    }
    ...
    void putExistingSector() throws Exception {
        ...
        updatedSector.name(UPDATED_NAME).code(UPDATED_CODE);
    ...
    void partialUpdateSectorWithPatch() throws Exception {
        ...
        partialUpdatedSector.name(UPDATED_NAME).code(UPDATED_CODE);
