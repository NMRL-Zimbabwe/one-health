...
import zw.nmrl.onehealth.domain.Country;
import zw.nmrl.onehealth.repository.CountryRepository;
...
class CountryResourceIT {
    ...
    public static Country createEntity(EntityManager em) {
        Country country = new Country().name(DEFAULT_NAME).longitude(DEFAULT_LONGITUDE).latitude(DEFAULT_LATITUDE);
        return country;
    }
    ...
    public static Country createUpdatedEntity(EntityManager em) {
        Country country = new Country().name(UPDATED_NAME).longitude(UPDATED_LONGITUDE).latitude(UPDATED_LATITUDE);
        return country;
    }
    ...
    void putExistingCountry() throws Exception {
        ...
        updatedCountry.name(UPDATED_NAME).longitude(UPDATED_LONGITUDE).latitude(UPDATED_LATITUDE);
    ...
    void partialUpdateCountryWithPatch() throws Exception {
        ...
        partialUpdatedCountry.name(UPDATED_NAME).longitude(UPDATED_LONGITUDE).latitude(UPDATED_LATITUDE);
