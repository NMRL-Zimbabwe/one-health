...
type DistrictFormGroupContent = {
  ...
  provinceId: FormControl<IDistrict['provinceId']>;
  longitude: FormControl<IDistrict['longitude']>;
  latitude: FormControl<IDistrict['latitude']>;
};
...
export class DistrictFormService {
  createDistrictFormGroup(district: DistrictFormGroupInput = { id: null }): DistrictFormGroup {
    ...
    return new FormGroup<DistrictFormGroupContent>({
      ...
      provinceId: new FormControl(districtRawValue.provinceId, {
        validators: [Validators.required],
      }),
      longitude: new FormControl(districtRawValue.longitude),
      latitude: new FormControl(districtRawValue.latitude),
    });
  }
