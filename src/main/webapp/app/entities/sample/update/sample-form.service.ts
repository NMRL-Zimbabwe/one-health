...
type SampleFormGroupContent = {
  ...
  longitude: FormControl<ISample['longitude']>;
  latitude: FormControl<ISample['latitude']>;
};
...
export class SampleFormService {
  createSampleFormGroup(sample: SampleFormGroupInput = { id: null }): SampleFormGroup {
    ...
    return new FormGroup<SampleFormGroupContent>({
      ...
      longitude: new FormControl(sampleRawValue.longitude),
      latitude: new FormControl(sampleRawValue.latitude),
    });
  }
