...
import { EntityArrayResponseType, ClientAddressService } from '../service/client-address.service';
...
export class ClientAddressComponent implements OnInit {
  ...
  trackId = (_index: number, item: IClientAddress): number => this.clientAddressService.getClientAddressIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.clientAddresses = this.refineData(dataFromBody);
  }

  protected refineData(data: IClientAddress[]): IClientAddress[] {
